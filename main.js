...
var SLASH_COMMANDS = [
  ...
  { command: '/workflow-review-note', label: '/workflow-review-note', description: 'Review the active note using vault workflow conventions', prompt: 'Use the appropriate workflow from `_agent/workflows` if present. Review the active note for structure, clarity, links, tags, stale claims, and actionable next edits. Distinguish fact, inference, interpretation, and suggestion.' },
  { command: '/workflow-create-note', label: '/workflow-create-note', description: 'Draft a new note using vault workflow conventions', prompt: 'Use the note-creation workflow from `_agent/workflows` if present. Ask only for missing essentials. Draft a vault-native Markdown note with frontmatter, wikilinks where useful, and clear status.' },
  { command: '/workflow-research-pack', label: '/workflow-research-pack', description: 'Build a research context pack from selected/current material', prompt: 'Use the research/context-pack workflow from `_agent/workflows` if present. Build a concise context pack: question, sources/material, claims, uncertainties, connections, and next actions.' },
  { command: '/workflow-literature', label: '/workflow-literature', description: 'Analyze literary or scholarly material', prompt: 'Use the literature-analysis workflow from `_agent/workflows` if present. Analyze the selected/current material with attention to evidence, interpretation, uncertainty, and useful vault links.' },
  { command: '/workflow-rpg', label: '/workflow-rpg', description: 'Prepare RPG/campaign material safely', prompt: 'Use the RPG/campaign workflow from `_agent/workflows` if present. Develop usable RPG material while keeping private campaign canon distinct from public-facing adaptation.' },
];
...
// Icons
// ============================================
// Embedded from /home/ewroblewski/Pictures/icons/hermes-terminal-icon-transparent.svg.
...
// ============================================
function workflowCommandsFromVault(app) {
  try {
    return app.vault.getMarkdownFiles()
      .filter(f => f.path.startsWith('_agent/workflows/'))
      .map(f => {
...
var SlashCommandPopup = class {
  ...
  updateList(query) {
    ...
    const workflowCmds = workflowCommandsFromVault(this.plugin.app);
...
var HermesPlugin = class extends import_obsidian.Plugin {
  ...
  async onload() {
    ...
    const workflowCommandDefs = [
      { id: "workflow-review-note", name: "Hermes workflow: Review active note", prompt: "Use the appropriate workflow from `_agent/workflows` if present. Review the active note for structure, clarity, links, tags, stale claims, and actionable next edits. Distinguish fact, inference, interpretation, and suggestion." },
      { id: "workflow-create-note", name: "Hermes workflow: Create note", prompt: "Use the note-creation workflow from `_agent/workflows` if present. Ask only for missing essentials. Draft a vault-native Markdown note with frontmatter, wikilinks where useful, and clear status." },
      { id: "workflow-research-pack", name: "Hermes workflow: Build research context pack", prompt: "Use the research/context-pack workflow from `_agent/workflows` if present. Build a concise context pack: question, sources/material, claims, uncertainties, connections, and next actions." },
      { id: "workflow-literature", name: "Hermes workflow: Analyze literature/scholarship", prompt: "Use the literature-analysis workflow from `_agent/workflows` if present. Analyze the selected/current material with attention to evidence, interpretation, uncertainty, and useful vault links." },
      { id: "workflow-rpg", name: "Hermes workflow: Prepare RPG material", prompt: "Use the RPG/campaign workflow from `_agent/workflows` if present. Develop usable RPG material while keeping private campaign canon distinct from public-facing adaptation." }
    ];
